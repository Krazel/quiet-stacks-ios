...
await writeFile(new URL('./artifacts/web-build.json',import.meta.url),JSON.stringify({version:'0.16.6',files,engine:'HTML + Canvas 2D + JavaScript',dependencies:0},null,2));
