(() => {
  ...
  $('plus').onclick=()=>zoom(1.25);$('minus').onclick=()=>zoom(.8);$('home').onclick=()=>{if(autoTesting)return;camera().zoom=1;camera().x=W/2;camera().y=H/2;constrain();save();};
