...
function run(cmd,args){console.log('QA step:',cmd,args.slice(0,3).join(' '));const r=spawnSync(cmd,args,{encoding:'utf8',maxBuffer:20*1024*1024,timeout:180000});if(r.status!==0)throw Error(r.stderr||r.stdout);return r.stdout.trim();}
